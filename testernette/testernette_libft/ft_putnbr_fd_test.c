...
/*   Updated: 2023/01/06 19:51:57 by lspohle          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_putnbr_fd_test(int *value)
{
    ...
    int     fd = open("../txt_files_libft/ft_putnbr_fd_test.txt", O_RDWR);
    FILE    *fileCheck;
    FILE    *fileTest;
    ...
    fileCheck = fopen("../txt_files_libft/ft_putnbr_fd_check.txt", "r");
    fileTest = fopen("../txt_files_libft/ft_putnbr_fd_test.txt", "r");
