...
void	ft_putendl_fd_test(int *value)
{
    ...
    int     fd = open("../txt_files_libft/ft_putendl_fd_test.txt" , O_RDWR);
    FILE    *fileCheck;
    FILE    *fileTest;
    ...
    fileCheck = fopen("../txt_files_libft/ft_putendl_fd_check.txt", "r");
    fileTest = fopen("../txt_files_libft/ft_putendl_fd_test.txt", "r");
